...
namespace DominioEntidades.SisReservas
{
    ...
    public partial class O_ASIENTO : INotifyComplexPropertyChanging, INotifyPropertyChanged
    {
        ...
        public static void RecordComplexOriginalValues(String parentPropertyName, O_ASIENTO complexObject, ObjectChangeTracker changeTracker)
        {
